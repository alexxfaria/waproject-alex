...
import CartAddIcon from 'mdi-react/CartAddIcon';
...
import SaleIndexPage from './Sales';
...
const AdminPage = memo((props: {}) => {
  ...
  const [menu] = useState([
    ...
    { path: '/pedidos', display: 'Pedidos', icon: CartAddIcon }
  ]);
        ...
        <Drawer menu={menu}>
          <main ref={mainContent} className={classes.content}>
            <Switch>
              ...
              <Route path='/pedidos' component={SaleIndexPage} />
